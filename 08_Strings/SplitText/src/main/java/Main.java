public class Main {
    ...
    public static void main(String[] args) {
        ...
        String textIn = "Everyone could notice that people often complain and say that it was better before. It may be a little nostalgia;\n" +
        ...
        textIn = splitTextIntoWords(textIn);
